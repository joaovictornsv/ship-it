...
export function SaveUntrustedBanner() {
  ...
  return (
    <div
      role="status"
      className="border-b border-[var(--ship-line)] border-l-4 border-l-[var(--ship-accent-deep)] bg-[color-mix(in_srgb,var(--ship-bg-elevated)_94%,transparent)] py-2"
    >
      <div className="mx-auto flex max-w-6xl items-start justify-between gap-3 px-4 text-left">
