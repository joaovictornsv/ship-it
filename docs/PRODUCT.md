...
- **Max rendered** sprites with LOD / `×N` Dev badge at high counts (tech lean: 24–48).
...
- Scene should remain readable at 0, 10, 100+ entities (cap rendered sprites, show Dev “×N” badge, or crowd LOD).
