...
- Shell chrome stays quiet until then: a discrete Rewrite CTA (no always-on grayed panel or Rewrites shop in the normal shop). Prestige spend happens in the Rewrite flow after confirm.
